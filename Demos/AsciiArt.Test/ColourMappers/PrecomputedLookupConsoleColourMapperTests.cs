// <copyright file="PrecomputedLookupConsoleColourMapperTests.cs" company="Simon Bridewell">
...
namespace Sde.AsciiArt.Test.ColourMappers
{
    ...
    /// <summary>
    /// Unit tests for <see cref="PrecomputedLookupConsoleColourMapper"/>.
    /// </summary>
    public class PrecomputedLookupConsoleColourMapperTests
    {
        private readonly PrecomputedLookupConsoleColourMapper mapper = new PrecomputedLookupConsoleColourMapper();
