// <copyright file="Cie94ConsoleColourMapperTests.cs" company="Simon Bridewell">
...
namespace Sde.AsciiArt.Test.ColourMappers
{
    ...
    /// <summary>
    /// Unit tests for <see cref="Cie94ConsoleColourMapper"/>.
    /// </summary>
    public class Cie94ConsoleColourMapperTests
    {
        private readonly Cie94ConsoleColourMapper mapper = new Cie94ConsoleColourMapper();
