// <copyright file="Cie76ConsoleColourMapperTests.cs" company="Simon Bridewell">
...
namespace Sde.AsciiArt.Test.ColourMappers
{
    ...
    /// <summary>
    /// Unit tests for <see cref="Cie76ConsoleColourMapper"/>.
    /// </summary>
    public class Cie76ConsoleColourMapperTests
    {
        private readonly Cie76ConsoleColourMapper mapper = new Cie76ConsoleColourMapper();
