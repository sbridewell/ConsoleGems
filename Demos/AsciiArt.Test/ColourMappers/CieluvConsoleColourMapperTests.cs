// <copyright file="CieluvConsoleColourMapperTests.cs" company="Simon Bridewell">
...
namespace Sde.AsciiArt.Test.ColourMappers
{
    ...
    /// <summary>
    /// Unit tests for <see cref="CieluvConsoleColourMapper"/>.
    /// </summary>
    public class CieluvConsoleColourMapperTests
    {
        private readonly CieluvConsoleColourMapper mapper = new CieluvConsoleColourMapper();
