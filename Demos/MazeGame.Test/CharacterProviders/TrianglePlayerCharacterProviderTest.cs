// <copyright file="TrianglePlayerCharacterProviderTest.cs" company="Simon Bridewell">
...
namespace Sde.MazeGame.Test.CharacterProviders
{
    ...
    /// <summary>
    /// Unit tests for the <see cref="TrianglePlayerCharacterProvider"/> class.
    /// </summary>
    public class TrianglePlayerCharacterProviderTest
    {
        /// <summary>
        ...
        {
            // Arrange
            var provider = new TrianglePlayerCharacterProvider();
