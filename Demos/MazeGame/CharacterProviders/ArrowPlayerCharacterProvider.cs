// <copyright file="ArrowPlayerCharacterProvider.cs" company="Simon Bridewell">
...
namespace Sde.MazeGame.CharacterProviders
{
    ...
    /// <summary>
    /// This implementation represents the player as an arrow which
    /// points in the direction that the player is facing.
    /// </summary>
    public class ArrowPlayerCharacterProvider : IPlayerCharacterProvider
    {
